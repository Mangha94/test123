...
<script>
    function deleteCategoryv(cardCategoryNo) {
        ...
        location.href = "/card?cmd=getNo&cardCategoryNo="+ cardCategoryNo +"&contentNo=" + contentNo+"&commentNo="+commentNo;
    }
</script>
    ...
    <c:forEach items="${categoryList}" var="category">
        ...
        <div class="col-xs-12 col-md-12">
            ...
            <div class="list-group">
                <a href="/card?cardCategoryNo=${category.cardCategoryNo}"
                   class="list-group-item active">${category.cardCategoryTitle}</a>
                <a href="javascript:modifyCategoryv(${category.cardCategoryNo})" class="btn btn-warning">edit</a>
                <a href="javascript:deleteCategoryv(${category.cardCategoryNo})" class="btn btn-danger">delete</a>
